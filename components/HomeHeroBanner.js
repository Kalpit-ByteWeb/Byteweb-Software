  ...
  return (
    <section className="bg-byteweb-software-gradient h-[1049px]">
      <div className="container mx-auto flex flex-col md:flex-row py-88">
        ...
        <h1 className="font-heading text-sm font-semibold mb-2 text-white">
            Software agency
          </h1>
          <h2 className="font-heading text-xl font-bold mb-4 leading-80 text-white">
          ...
          <div className="flex justify-center md:justify-start space-x-4">
            <Link href="/contact-us" legacyBehavior>
              <a className="bg-primary font-heading  text-white font-medium py-4 px-8 rounded-lg shadow-button-box-shadow-2">
                Contact Us
              </a>
            </Link>
            <Link href="/services" legacyBehavior>
              <a className="bg-transparent font-heading border-primary border text-primary font-medium py-4 px-8 rounded-lg shadow-button-box-shadow-2">
                Our Services
              </a>
            </Link>
          </div>
